...
This diagram illustrates the end-to-end workflow of the project, from collecting product reviews to preparing a sentiment-analysis-ready dataset.
...
5. Reviews are cleaned using **spaCy NLP pipeline**
